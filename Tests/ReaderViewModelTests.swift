...
final class ReaderViewModelTests: XCTestCase {
    ...
    func testPrefetchManagerQueueBehavior() async {
        ...
        // Enqueue 3 chương
        await prefetcher.updateQueue(withVisibleIndexes: [1, 2, 3], fetcher: fetcher)
    ...
    func testPrefetchManagerCancelBehavior() async {
        ...
        // Enqueue
        await prefetcher.updateQueue(withVisibleIndexes: [1, 2], fetcher: fetcher)
        
        // Ngay lập tức cập nhật hàng đợi mới loại bỏ chương 2
        try? await Task.sleep(nanoseconds: 50_000_000)
        await prefetcher.updateQueue(withVisibleIndexes: [1], fetcher: fetcher)
