...
generated_at: 2026-07-14T09:30:00+07:00
git_commit: UNKNOWN
source_files: 87
document_version: 3
---
...
- **Validation Failure Policy**: Nếu kịch bản xác thực tự động (`validate_links.py`) phát hiện bất kỳ lỗi nào (như tệp manifest không khớp, liên kết chết, sai định dạng front matter hoặc GENERATED comment), AI bắt buộc phải tiến hành sửa đổi tệp bị lỗi và chạy lại kịch bản validation. Không được báo cáo hoàn thành nhiệm vụ khi validation chưa PASS 100%.
