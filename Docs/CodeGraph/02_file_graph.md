...
| [`…/QuickTranslationRuleSnapshot.swift`](../../Sources/Services/Translation/Engine/QuickTranslationRuleSnapshot.swift) | bản chụp bất biến: revision SHA-256, `generation`, rule/literal index và UUID hàng tạm | 82 |
...
| [`…/QuickTranslationRuleStore.swift`](../../Sources/Services/Translation/Engine/QuickTranslationRuleStore.swift) | `ObservableObject` singleton: nạp/tải/CRUD revision-guarded, validate-then-swap, `cacheTag` gồm chữ ký token, chẩn đoán | 392 |
...
| [`Views/Settings/Translation/QuickTranslationRuleListView.swift`](../../Sources/Views/Settings/Translation/QuickTranslationRuleListView.swift) | **màn riêng**: danh sách UUID-stable + `.searchable`, phân trang 200, badge cảnh báo, nút `+` và swipe Sửa/Xoá | 244 |
...
| [`Services/Translation/Engine/QuickTranslationRuleFileEditor.swift`](../../Sources/Services/Translation/Engine/QuickTranslationRuleFileEditor.swift) | phẫu thuật theo dòng, địa chỉ hoá/kiểm chứng pattern+replacement, trả metadata insert/replace/delete để remap UUID | 237 |
| [`Services/Translation/Extensions/QuickTranslationRuleStore+Editing.swift`](../../Sources/Services/Translation/Extensions/QuickTranslationRuleStore+Editing.swift) | CRUD Store giữ mutation lock/revision rồi đi qua import nội bộ để validate-then-swap | 130 |
